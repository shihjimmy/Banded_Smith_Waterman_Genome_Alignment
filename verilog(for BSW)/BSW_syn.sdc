read_file -format verilog  "BSW.v"
current_design [get_designs BSW]
...
#####################################################
compile
write_sdf -version 2.1 BSW_syn.sdf
write -format verilog -hier -output BSW_syn.v
write -format ddc     -hier -output BSW_syn.ddc  
#####################################################  